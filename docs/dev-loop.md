...
pnpm dev:inject gmail-message [--subject "<s>"] [--from <email>] [--body "<b>"] \
  [--expire-history]   # drop a message into the fake mailbox + fire the poll in-process; run `pnpm dev:gmail setup` first
```
