...
const INTENT_INDEX: IntentEntry[] = [
  { intent: 'What an automation is, the cardinal rule, the conventions, reuse vs copy', chapter: 'foundations' },
  ...
  { intent: 'A mailbox: run on arriving mail, search it, send and reply', chapter: 'system:gmail' },
  ...
  { intent: 'Do something per attachment or related record, and collect what it produced', chapter: 'traversal', section: 'blocks' },
  ...
  { intent: 'What a person or company does, from a name, a link or a profile', chapter: 'plugin:research' },
  ...
  { intent: 'A source that may be several record kinds; stopping a run with a reason', chapter: 'branching', section: 'narrowing' },
  { intent: 'Compose a message quoting earlier writes', chapter: 'expressions', section: 'interpolation' },
  { intent: 'Approve or decide before a write, then resume; let a person choose', chapter: 'reviews', section: 'delivering-and-awaiting' },
  { intent: 'A reminder or default if nobody answers; answer now or defer', chapter: 'reviews', section: 'timeout-and-escalation' },
  { intent: 'One question to several places', chapter: 'reviews', section: 'several-at-once' },
  { intent: 'Buttons in a chat, a tap that carries a value, a link that acts when opened', chapter: 'reviews', section: 'in-chat-answers' },
  ...
  { intent: "Reuse one automation from another; hand a result out of its body", chapter: 'anatomy', section: 'composition' },
