...
const INTENT_INDEX: IntentEntry[] = [
  { intent: 'What an automation is, the cardinal rule, the conventions, and reusing vs copying one', chapter: 'foundations' },
  ...
  { intent: 'Find a record without creating one, or update one you already have', chapter: 'writes', section: 'looking-up-existing-records' },
  ...
  { intent: 'Connect a record to one that already exists', chapter: 'writes', section: 'link' },
  { intent: 'Do something for each attachment or related record, and collect what it produced', chapter: 'traversal', section: 'blocks' },
  ...
  { intent: 'Find out what a person or company does, from a name, a link, or a profile address', chapter: 'plugin:research' },
  ...
  { intent: "Today's date, the acting user, a record's owner", chapter: 'expressions', section: 'meta-fields' },
  { intent: 'Only act when a condition holds', chapter: 'branching', section: 'conditions' },
  { intent: 'A source that may be one of several record kinds, or stopping a run with a reason', chapter: 'branching', section: 'narrowing' },
  { intent: 'Compose a message quoting earlier writes', chapter: 'expressions', section: 'interpolation' },
  { intent: 'Approve or decide before a write, then resume; let a person choose or supply values', chapter: 'reviews', section: 'delivering-and-awaiting' },
  { intent: 'A reminder or default if nobody answers; answer now or defer as a callback', chapter: 'reviews', section: 'timeout-and-escalation' },
  { intent: 'One question to several places', chapter: 'reviews', section: 'several-at-once' },
  { intent: 'Buttons in a chat, a tap that carries a value, or a link that acts when opened', chapter: 'reviews', section: 'in-chat-answers' },
  ...
  { intent: 'Compose a report and attach it as a PDF or text file', chapter: 'patterns', section: 'compose-a-report' },
  ...
  { intent: 'Group, transform, count, or total a list of values', chapter: 'expressions', section: 'iterating-values' },
  ...
  { intent: "Reuse one automation from another; hand a result out of a body, or use a call's value", chapter: 'anatomy', section: 'composition' },
  ...
  { intent: 'Which relationships come back in order, and why a filter or sort gets blocked at the source', chapter: 'traversal', section: 'record-order' },
  { intent: 'Rehearse an automation before going live', chapter: 'anatomy', section: 'constructions' },
  { intent: 'Check what a run did, and trace where a written value came from', chapter: 'runs', section: 'run-history' },
  ...
  { intent: 'Exact spelling of an operator or function, or when a name needs backticks', chapter: 'reference', section: 'operators-and-functions' },
  { intent: 'Write field modifiers and unique by forms, or traversal and query clause syntax', chapter: 'reference', section: 'writes' },
