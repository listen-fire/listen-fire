...
const INTENT_INDEX: IntentEntry[] = [
  ...
  { intent: 'Answer now, or defer as a callback', chapter: 'reviews', section: 'when-a-question-and-when-a-callback' },
  ...
  { intent: 'Build a scheduled digest', chapter: 'patterns', section: 'scheduled-digest' },
  ...
  { intent: 'A report section per value of a type', chapter: 'patterns', section: 'sections-from-a-type' },
  ...
  { intent: 'What makes a run expensive', chapter: 'runs', section: 'what-a-run-costs' },
