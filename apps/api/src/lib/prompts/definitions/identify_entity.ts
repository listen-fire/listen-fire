...
const identifyEntityDef = promptDef({
  description:
...
You will be sent a message that contains information about an entity (like startups, founders, investors, funds, etc).

This message has one particular entity as the subject. It is typically the most actionable thing in the text: the startup that is raising a funding round, a founder in stealth that may be raising money soon, or a VC firm that is looking for funding from potential LPs.
Importantly, an <IDENTIFICATION_META> tag may be present in the message. This tag will contain the name of the entity that the message is about. If a <IDENTIFICATION_META> tag is present, the name in the <IDENTIFICATION_META> indicates the entity we care about.
...
- "type", one of the following options that best describes the entity:
    ...
    - "fund",
    - "other"
- "description" (string | null), a concise, 1 sentence description of the entity
- "country" (string | null), the country ISO code of the entity. 
